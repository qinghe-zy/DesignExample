...
<template>
  <AppShellSection
    ...
    title="Menu and route baseline"
    description="Menu records double as a route-control extension point. The current implementation keeps navigation simple while leaving room for richer dynamic routing later."
  >
