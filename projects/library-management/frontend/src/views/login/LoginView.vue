...
async function submit() {
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      ElMessage.success('Signed in to the library management workspace')
...
<template>
  <main class="login-shell">
    <section class="intro-strip">
      ...
      <h1 class="display-title">A reusable library-management starter for catalog, reader, and circulation workflows.</h1>
      <p class="muted intro-copy">
        This derived starter keeps the shared authentication and system baseline, then adds the first library-focused business flows that often recur in graduation-project systems.
      </p>
      <ul class="signal-list">
        <li>Book catalog</li>
        <li>Reader management</li>
        <li>Borrow and return tracking</li>
      </ul>
    </section>
    ...
    <section class="panel-card login-card">
      <div>
        ...
        <h2>Sign in to the library management example</h2>
