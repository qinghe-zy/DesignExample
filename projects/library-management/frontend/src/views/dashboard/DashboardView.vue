...
<template>
  <AppShellSection
    ...
    title="A circulation-ready workspace derived from the shared admin base."
    description="The dashboard keeps the validated auth and system core, then focuses this seed on catalog, reader, and borrow-return operations."
  >
