...
async function submit() {
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      ElMessage.success('Signed in to the base admin workspace')
...
<template>
  <main class="login-shell">
    <section class="intro-strip">
      ...
      <h1 class="display-title">A durable admin baseline for the next wave of template projects.</h1>
      <p class="muted intro-copy">
        This starter is intentionally lean: authentication, dashboard, system baseline modules, and one
        representative CRUD flow that future course-design systems can inherit without dragging in accidental complexity.
      </p>
      <ul class="signal-list">
        <li>JWT + RBAC skeleton</li>
        <li>Shared system modules</li>
        <li>Reusable CRUD conventions</li>
      </ul>
    </section>
    ...
    <section class="panel-card login-card">
      <div>
        ...
        <h2>Sign in to the base admin example</h2>
