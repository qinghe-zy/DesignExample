...
<template>
  <AppShellSection
    eyebrow="Admin Baseline"
    title="A shared launchpad for future academic systems."
    description="The dashboard keeps the first template intentionally focused: prove the common stack, expose the baseline modules, and leave clean space for later business specialization."
  >
