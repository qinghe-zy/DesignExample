...
async function submit() {
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      ElMessage.success('Signed in to the student-management workspace')
...
<template>
  <main class="login-shell">
    <section class="intro-strip">
      ...
      <h1 class="display-title">A reusable student-management starter for archive, class, and score workflows.</h1>
      <p class="muted intro-copy">
        This derived starter keeps the shared authentication and system baseline, then adds the first
        student-focused business flows that often recur in course-design and graduation-project systems.
      </p>
      <ul class="signal-list">
        <li>Student archive</li>
        <li>Class and major management</li>
        <li>Score and discipline tracking</li>
      </ul>
    </section>
    ...
    <section class="panel-card login-card">
      <div>
        ...
        <h2>Sign in to the student-management example</h2>
