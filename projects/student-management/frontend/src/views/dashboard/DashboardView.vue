...
<template>
  <AppShellSection
    ...
    title="A derived academic workspace built on the shared admin base."
    description="This dashboard keeps the validated auth and system baseline while focusing the seed on archive, class, score, and discipline management."
  >
